...
class AdversarialLoss(LambdaSheduler):
    def __init__(self, gamma=1.0, max_iter=1000, out_dim=256, **kwargs):
        super(AdversarialLoss, self).__init__(gamma=gamma, max_iter=max_iter, **kwargs)
        self.out_dim = out_dim
        self.domain_classifier = Discriminator(input_dim=self.out_dim)
...
class Discriminator(nn.Module):
    def __init__(self, input_dim=256, hidden_dim=256):      # input_dim changed to 16 for AeTransferNet 1-11-2022:ra opt
