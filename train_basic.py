...
from x_tools.train_util_basic import train_util_basic
...
def get_args():
    ...
    # training related
    parser.add_argument('--is_save_checkpoint', type=int, default=0)
    parser.add_argument('--is_continue_train', type=int, default=0)
